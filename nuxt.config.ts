...
const GA_MEASUREMENT_ID = 'G-Q4ETW7QZW0'
...
export default defineNuxtConfig({
  ...
  components: [
    // Components used from Markdown via MDC have to be registered globally.
  ...
  app: {
    head: {
      title: 'Fred Cogswell: The Many-Dimensioned Self',
      titleTemplate: '%s | Fred Cogswell: The Many-Dimensioned Self',
      link: [
